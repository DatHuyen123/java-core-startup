package com.dangvandat.core.bai1;
...
public class ReadNumber {
    ...
    public static void main(String[] args) throws ParseException {
        String number = "123";
        if (!VALID_NUMBER.matcher(number).find()) {
            System.out.println("hello");
            return;
        }
        System.out.print(numberToString(number));
    }
    public static String formatNumberForRead(String numberIns) {
        Double number = Double.parseDouble(numberIns);
    ...
    public static String numberToString(String numberIns) {
        Double number = Double.parseDouble(numberIns);
        String sNumber = formatNumberForRead(number.toString());
        // Tao mot bien tra ve
        String sReturn = "";
